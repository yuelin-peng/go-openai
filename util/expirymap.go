...
// copyright by chatgpt-telegram https://github.com/m1guelpf/chatgpt-telegram
...
func (em *ExpiryMap) Set(key string, value string, expiry time.Time) {
	em.mutex.Lock()
	defer em.mutex.Unlock()

	em.m[key] = value
	em.expiryMap[key] = expiry
}
